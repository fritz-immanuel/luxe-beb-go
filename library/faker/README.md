...
[![Build Status](https://travis-ci.org/atomic/go-bitu-sip/library/faker.svg?branch=master)](https://travis-ci.org/atomic/go-bitu-sip/library/faker)
[![codecov](https://codecov.io/gh/atomic/go-bitu-sip/library/faker/branch/master/graph/badge.svg)](https://codecov.io/gh/atomic/go-bitu-sip/library/faker)
[![Go Report Card](https://goreportcard.com/badge/luxe-beb-go/library/faker)](https://goreportcard.com/report/luxe-beb-go/library/faker)
[![License](https://img.shields.io/github/license/mashape/apistatus.svg)](https://luxe-beb-go/library/faker/blob/master/LICENSE)
[![GoDoc](https://godoc.org/luxe-beb-go/library/faker?status.svg)](https://godoc.org/luxe-beb-go/library/faker)
...
You can file an [Issue](https://luxe-beb-go/library/faker/issues/new).
See documentation in [Godoc](https://godoc.org/luxe-beb-go/library/faker)
...
```shell
go get -u luxe-beb-go/library/faker
```
## Example
...
### Maintainer
- <a href="https://luxe-beb-go/library">  **Iman Tumorang** </a> <br> 
